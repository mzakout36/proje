...
namespace OkulProje
{
    public partial class ogrencidersekran : Form
    {
        ...
        private void OgrenciDersPanel_Load(object sender, EventArgs e)
        {
            ...
            cmbogrenci.DataSource = ogrenciler; listeleme();
            ...
            cmbders.DataSource = dersler; listeleme();
        }
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            sor = MessageBox.Show("Kayıt Silinecektir.", "Sistem Mesajı", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
